...
- (void)viewDidLoad {
    ...
    self.pageControl.currentPageIndicatorTintColor=NAVBAR_Color;
    [self.view addSubview:self.pageControl];
    
    if (!self.enterButton) {//NSLocalizedString(@"Enter", nil)
        ...
        self.enterButton.layer.borderColor = NAVBAR_Color.CGColor;
        self.enterButton.clipsToBounds=YES;
        self.enterButton.layer.cornerRadius=20;
        //[self.enterButton setBackgroundColor:NAVBAR_Color];
        [self.enterButton setTitleColor:NAVBAR_Color forState:UIControlStateNormal];
    }
