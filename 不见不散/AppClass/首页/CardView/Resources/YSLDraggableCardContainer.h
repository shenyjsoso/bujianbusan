...
typedef void (^DraggableCardBlock)(NSInteger index);
 ...
 */
@property(nonatomic,copy)DraggableCardBlock leftblock;
@property(nonatomic,copy)DraggableCardBlock rightblock;
