...
static const CGFloat kSecondCard_Scale = 0.98;
static const CGFloat kTherdCard_Scale = 0.96;
static const CGFloat kCard_Margin = 9.0f;
static const CGFloat kDragCompleteCoefficient_width_default = 0.4f;
...
- (void)movePositionWithDirection:(YSLDraggableDirection)direction isAutomatic:(BOOL)isAutomatic undoHandler:(void (^__strong)(void))undoHandler
{
