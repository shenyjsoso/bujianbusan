...
- (void)showBrowserWithImages:(NSArray *)imageArray
{
   ...
   // SYJNavigationController *rootController= [self.keyWindow rootViewController];
   ...
   // [rootController presentViewController:self.photoNavigationController animated:YES completion:nil];
    if (rootController.presentedViewController) {
        ...
        [rootController.presentedViewController dismissViewControllerAnimated:false completion:^{
            [rootController presentViewController:self.photoNavigationController animated:true completion:nil];
        }];
    }else {
        [rootController presentViewController:self.photoNavigationController animated:YES completion:nil];
    }
