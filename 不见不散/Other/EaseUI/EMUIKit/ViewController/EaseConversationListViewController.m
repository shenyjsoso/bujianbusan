...
- (void)tableView:(UITableView *)tableView commitEditingStyle:(UITableViewCellEditingStyle)editingStyle forRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (self.dataArray.count==0) {
        [self.tableView addSubview:self.nochatView];
        self.nochatView.center=CGPointMake(ScreenWidth/2, ScreenHeight/2-100);
//        CGPoint nochatCneter=self.view.center;
//        nochatCneter.y-=STATUS_HEIGHT+NAVBAR_HEIGHT;
//        self.nochatView.center=nochatCneter;
    }
    else
    {
        [self.nochatView removeFromSuperview];
    }
}
